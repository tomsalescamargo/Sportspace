...
class CourtUI:
    def run_manage_courts(self, court_service, reservation_service):
        ...
        while True:
            ...
            if event in (sg.WIN_CLOSED, 'back_to_main'):
                ...
                self._run_court_form(court_service, None)
    ...
    def _run_court_form(self, court_service, court_to_edit=None):
        """
    ...
    def _run_update_delete_court_flow(self, court_service):
        """
        Executes the flow of selecting a court and then opening the form for editing or deletion
        """
        court_to_edit = self._run_court_search_window(court_service)

        if court_to_edit:
            self._run_court_form(court_service, court_to_edit)

    def _run_court_search_window(self, court_service):
        """
    ...
    def _run_list_courts_table(self, court_service):
        """
